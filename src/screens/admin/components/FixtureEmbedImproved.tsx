...
const FixtureEmbedImprovedComponent: React.FC<FixtureEmbedImprovedProps> = ({
  navigation,
  isAdmin = false,
  idEdicionCategoria
}) => {
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          if (isAdmin) {
            ...
            navigation.navigate('MatchDetail', { partidoId: partido.id_partido });
          }
        }}
        activeOpacity={0.7}
      >
...
export const FixtureEmbedImproved = React.memo(FixtureEmbedImprovedComponent);
